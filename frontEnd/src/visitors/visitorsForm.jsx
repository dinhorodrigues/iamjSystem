...
import desabilitaEnter, {init } from './visitorsActions'
import labelTextArea from '../common/form/labelTextArea';
        ...
        return (
            <form role='form' onSubmit={handleSubmit}>
                <div className='box-body'>
                    ...
                    <Field name='celular' component={labelAndInput} label='Celular' cols='12 3' className='form-control' placeholder='(83) 9999-9899' readOnly={readOnly} />
                    ...
                    <Field name='bairro' id='bairro' component={labelAndInput} label='Bairro' cols='12 2' className='form-control' placeholder='Jardim Botânico' readOnly={readOnly} />
                    ...
                    <Field name='convite' component={labelAndInput} label='Convite' className='form-control' cols='12 4' placeholder='Ex. Pedro' readOnly={readOnly} />
                    <Field name='obs' component={labelTextArea} label='Obervações' className='form-control' cols='11'
                     placeholder='Digite aqui as observações' readOnly={readOnly} />
...
VisitorsForm = reduxForm({ form: 'visitorsForm', destroyOnUnmount: false, })(VisitorsForm)
const selector = formValueSelector('visitorsForm')
const mapStateToPros = state => ({ visitors: selector(state, 'visitors') })
const mapDispatchToProps = dispatch => bindActionCreators({init},dispatch)
export default connect(mapStateToPros,mapDispatchToProps)(VisitorsForm)
