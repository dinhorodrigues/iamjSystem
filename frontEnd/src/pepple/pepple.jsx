...
import desabilitaEnter, { init, createPepple, updatePepple, deletePepple, search, changeName, consultaCep } from './peppleActions'
...
class Pepple extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div>
                <ContentHeader title='Membros' small='Cadastro' />
                <Content>
                    <Tabs>
                        <TabsHeader>
                        ...
                        <TabsContent>
                            ...
                            <TabContent id='tabcreate' >
                                <PeppleForm onSubmit={this.props.createPepple}  labelSubmit='Incluir'
                                    submitClass='primary' />
...
const mapDispatchToProps = dispatch => bindActionCreators({
    init, createPepple,
    updatePepple, deletePepple, search, changeName, consultaCep
}, dispatch)
